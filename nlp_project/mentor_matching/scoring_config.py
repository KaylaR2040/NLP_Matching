"""CSV-backed scoring configuration for mentor matching."""
...
class ScoringConfig:
    """In-memory scoring config loaded from ``scoring.csv``."""
...
def load_scoring_config(path: Path = DEFAULT_SCORING_CSV) -> ScoringConfig:
    """Load and cache the scoring configuration from ``scoring.csv``."""
